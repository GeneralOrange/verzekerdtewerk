<h2>Wat is en wat doet een aannemer?</h2>
...
<p>De taken van een aannemer zijn dan ook :</p>
<ul>
    ...
    <li>De aannemer verzorgd de juiste vakmannen voor uw klus per werkzaamheden.</li>
    <li>De aannemer regelt voor u de ontheffingen ( tenzij anders overeen gekomen in overeenkomst ) indien deze nodig zijn.</li>
    <li>De aannemer regelt een bouwvergunning voor u indien deze nodig is ( tenzij anders overeen gekomen in overeenkomst ).</li>
...
<p>Bent u van plan om een aannemer in te schakelen? Dan zit u bij verzekerd te werk op de goede plek! Meld u snel aan om uw klus te plaatsen en zo uw geweldig project te kunnen realiseren!</p>
<button class="btn btn-success js-">Meld je nu aan</button>